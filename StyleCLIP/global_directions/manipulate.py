...
from StyleCLIP.global_directions.dnnlib import tflib
from StyleCLIP.global_directions.utils.visualizer import HtmlPageVisualizer
...
class Manipulator():
    def __init__(self,dataset_name='ffhq', sess=None):
        self.file_path='StyleCLIP/global_directions/'
